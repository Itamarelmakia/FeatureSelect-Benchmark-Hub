...
**Article:** Elmakias, I., Kolsky, D., & Vilenchik, D. (2026). *Feature Stability as a Trust
Layer for Feature Selection: Resampling-Based Recurrence Profiles Beyond Predictive
Performance.* Mathematics, 14(13), 2372.
**Status:** Published. DOI: [10.3390/math14132372](https://doi.org/10.3390/math14132372)

This directory contains the public reproducibility package for the stability paper
(stability-analysis companion to the FeatureSelect-Benchmark-Hub pipeline).
...
`data/scikit-feature/SMK-CAN-187.mat` — these are the expected local paths once you have
downloaded and extracted the benchmark archive under `data/` (see
[../../data/README.md](../../data/README.md)). They are not committed to this public repo.
...
Real-data experiments use datasets expected under the hub's local `data/` directory
(populated from the external archive, not committed to git).
See [../../data/README.md](../../data/README.md) for dataset sources and how to obtain them.
